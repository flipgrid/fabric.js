/* build: `node build.js modules=ALL exclude=gestures,accessors,animation,easing,parser,pattern,gestures,object_straightening,image_filters minifier=uglifyjs` */
